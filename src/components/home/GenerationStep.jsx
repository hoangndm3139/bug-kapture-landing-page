...
const generationStepData = [
  {
    ...
    note: "Add the Snapifies Chrome Extension to your browser in one click.",
  },
  {
    icon: <DocumentTextIcon className="w-10 h-10 inline-block mr-2" />,
    description: "Snap a Page",
    note: "Capture any website — full page or viewport. One click or automated.",
  },
  {
    icon: <ArrowDownOnSquareIcon className="w-10 h-10 inline-block mr-2" />,
    description: "View It Live",
    note: "Your screenshots show up in your dashboard and auto-refresh as the page changes.",
  },
];
      ...
      <div className="grid place-items-center w-full ">
        <div className="max-w-6xl w-full py-24 px-4 content-center justify-center">
          ...
          <div className="mt-12 lg:flex justify-evenly hidden">
            ...
            >
              <path
                d="M78.7579 13.679L79.8989 20.8159C79.8989 20.8159 81.2497 28.2987 80.624 28.0357M80.624 28.0357C80.624 28.0357 77.4568 25.9551 75.4412 25.0561C72.967 23.9525 69.3096 22.685 69.3096 22.685M80.624 28.0357C75.726 18.0645 60.8342 3.08096 42.9984 1.99997C24.4935 0.878426 10.3243 8.75092 1.50161 25.0558"
                stroke="#CCCCCC"
                stroke-width="1.92963"
            ...
            {generationStepData.map((i, k) => {
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 p-7 text-center justify-between items-center">
                    <p>{i.icon}</p>
                    <p className="text-lg font-bold"> {i.description}</p>
